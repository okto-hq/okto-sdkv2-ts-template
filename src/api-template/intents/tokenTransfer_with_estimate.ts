/*
 * This script explains how to perform a token transfer with estimate intent when the session config for a user is stored securely and retrieved after successful auth
 ...
 * Following function uses estimateUserOp API to fetch estimate of transaction.
 * Once we know the estimate, we can either proceed or reject to sign and execute the transaction.
