...
export async function sendOtp() {
    const payload = {
        email: "saakshiraut28@gmail.com", // Replace with the user's Email ID
...
verifyOtp("97fe0839-eb3b-5ab1-a91a-104d879d716d", "093815"); // Replace with actual token and OTP
// Sample Response:
// OTP Verified: {
//   status: 'success',
//   data: {
...
OktoAuthTokenGenerator("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..YdvDCQ54VSQ0brS8ELJFqqH4GTp75JdB10DBw9dQVWQ", "okto") // Replace with actual auth_token received from the verifyOtp() response
// Sample Response:
